...
import './About.css';
import alamgir from '../../images/brand pic.jpg';
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-5">
                                            <div class="about-img">
                                                <img src={alamgir} class="img-fluid rounded b-shadow-a" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-7">
                                            <div class="about-info">
                                                <p><span class="title-s">Name: </span> <span className="title-v">Md Alamgir Hossan</span></p>
                                                <p><span class="title-s">Profile: </span> <span className="title-v">Front End Web Developer</span></p>
                                                <p><span class="title-s">Email: </span> <span className="title-v">alamgirhossann@gmail.com</span></p>
                                                <p><span class="title-s">Phone: </span> <span className="title-v">+880 1719418587</span></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="skill-mf">
                                ...
                                <div class="col-md-6">
                                    <div class="about-me pt-4 pt-md-0">
                                        ...
                                        <p class="lead">
                                            Finally,Dedicated and efficient front end web developer with 3+ months of experience in application layers, presentation layers, and databases.
                                        </p>
                                    </div>
                                </div>
                            </div>
